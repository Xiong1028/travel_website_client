    ...
    return (
      <div className="mdbfooter">
        <MDBFooter color="black" className="font-small pt-4 mt-4">
          <MDBContainer
            fluid
            className="footer-copyright text-center text-md-left"
          >
            <MDBRow>
              <MDBCol md="12" style={{ width: "100%", textAlign: "center" }}>
                <a
                  href="/"
                  style={{ color: "#888888", fontFamily: "'Lobster', cursive" }}
                  className="title"
                >
                  Tripinterest
                </a>
                ...
                <a
                  href="mailto: hui.sun1926@gmail.com"
                  style={{
                    color: "#888888",
                    fontFamily: "'Poppins', sans-serif"
                  }}
